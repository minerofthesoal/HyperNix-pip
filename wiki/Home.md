...
- **0.51.1.1** — logo present and accounted for: `assets/logo.png` (1408×768 RGBA, 670 KB) + the smaller transparent variant `assets/logo1.png` are now in the repo, so the raw-GitHub `<img>` tag at the top of the README renders on the PyPI project page. No code changes from 0.51.1.
