...
* :mod:`hypernix.old_oven` — :class:`CodeOven`, :func:`preheat`,
  :func:`new_oven`, plus the :data:`ARCH_PRESETS` seedDEFAULT_MODEL = "qwen3.5-4b"  # New default model
sh-init models across the Llama / Qwen / Gemma / Phi / GLM /
