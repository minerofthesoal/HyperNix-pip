...
const CLI_COMMANDS = [
  ...
  { cmd: 'hypernix assistant', args: '[--voice] [--model <name>]', desc: 'Interactive assistant REPL with /system, /voice commands. Known limitation: --model is currently ignored — replies come from a small hardcoded demo responder, not a real LLM.' },
