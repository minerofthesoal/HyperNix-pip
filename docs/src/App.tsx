...
function getActiveSiteEvent(now = new Date()) {
  ...
  if (month === 7 && day === 4) {
    return { id: `july4-${year}`, kind: 'july4' }
  }
  if (month === 6) {
...
function EventBanner({ event, dismissed, onDismiss }) {
  ...
  if (event.kind === 'pride') {
    ...
    content = (
      <>
        <AmericanFlagIcon />
        <span>Happy 4th of July from the HyperNix team!</span>
        <AmericanFlagIcon />
      </>
    )
...
export default function App() {
  ...
  return (
    <div style={{ minHeight:'100vh', background:'#0d0d0d', color:'#f0f0f0',
      ...
      `}</style>
      <EventBanner event={activeEvent} dismissed={bannerDismissed} onDismiss={() => setBannerDismissed(true)} />
